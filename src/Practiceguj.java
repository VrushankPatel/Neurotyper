 ...
 * @author Vrushank
 */
public class Practiceguj extends javax.swing.JFrame {

    String s1, s2, maintext,pra,id,name2;
    int posX, posY,record,temp;
    int error;
    layout l=new layout("guj");
    public Practiceguj(String st1, String st2,String practice,int rec,int err,String ID2,String name) {
        s1 = st1;
        s2 = st2;
        temp=0;
        id=ID2;
    ...
    private void initComponents() {
        ...
        element8lbl8.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element10.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element10lbl10.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element11.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element1fld1.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element12.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element2fld1.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element13.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element3fld4.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element14.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element4fld5.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element15.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element5fld6.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element16.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element6lbl7.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element17.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element7lbl8.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element8lbl9.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element18.setFont(new getfont().getone2(Font.PLAIN,40f));
        element18.setForeground(new java.awt.Color(102, 153, 255));
        element18.setText(s2);

        element19.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element9lbl10.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element20.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        element10lbl11.setFont(new getfont().getone2(Font.PLAIN,40f));
    ...
    private void controlfld2(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_controlfld2
        ...
        if (jf.getText().length() == s2.length() && evt.getKeyChar() != 8) {
            ...
            }else if(jf.getText().equals(s2) && getFocusOwner()==element10lbl11)
            {
                ...
                if(a==0)
                {
                    new Practiceguj(s1,s2,pra,record,error,id,name2);
                    this.dispose();                    
                }
                else
                {
