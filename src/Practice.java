...
public class Practice extends javax.swing.JFrame {
    ...
    int posX, posY,record;
    int error;

    public Practice(String st1, String st2,String practice,int rec,int err,String ID2,String name) {
        s1 = st1;
        s2 = st2;
        id=ID2;
        name2=name;
    ...
    private void initComponents() {
        ...
        Titlelbl.setFont(new getfont().getone(55f));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(Titlelbl, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void controlfld2(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_controlfld2
        ...
        if (jf.getText().length() == s2.length() && evt.getKeyChar() != 8) {
            ...
            else if(jf.getText().equals(s2) && getFocusOwner()==element10lbl11)
            {
                ...
                if(a==0)
                {
                    new Practice("ASDFGF",";LKJHJ",pra,record,error,id,name2);
                    this.dispose();                    
                }
                else
                {
