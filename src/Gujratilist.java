...
public class Gujratilist extends javax.swing.JFrame {
    String name2,ID2;
    int posX,posY;
    public Gujratilist(String ID,String name) {
        name2=name;
        ID2=ID;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Every Practice will train your fingers for different key-patterns of keyboard with Gujrati saral layout");
    ...
    private void Practice1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Practice1MouseClicked
        new Practiceguj("kqg6c0j","z3#D!`t","Gujrati Practice 1",-1,0,ID2,name2);
        this.dispose();
    ...
    private void Practice2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Practice2MouseClicked
        new Practiceguj("4d2npfb","wmyrlvx","Gujrati Practice 2",-1,0,ID2,name2);
        this.dispose();
    ...
    private void Practice3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Practice3MouseClicked
        new Practiceguj("8sh59)1","AAa[{]}","Gujrati Practice 3",-1,0,ID2,name2);
        this.dispose();
    ...
    private void Practice4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Practice4MouseClicked
        new Practiceguj("AAaAeAE","AoAOA>A:","Gujrati Practice 4",-1,0,ID2,name2);
        this.dispose();
    ...
    private void Practice5KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Practice5KeyTyped
        new Practiceguj("AeBDomInl","k/oimymklR","Gujrati Practice 5",-1,0,ID2,name2);
        this.dispose();
    ...
    private void Practice7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Practice7MouseClicked
        new Practiceguj("FlurosN3","vUDnSvoDRz","Gujrati Practice 7",-1,0,ID2,name2);
        this.dispose();
    ...
    private void Practice6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Practice6MouseClicked
        new Practiceguj("ivK3orIya","sa{DiKvS3","Gujrati Practice 6",-1,0,ID2,name2);
        this.dispose();
    ...
    private void Practice8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Practice8MouseClicked
        new Practiceguj("isLvrS3En","Deivl3/a{>gl","Gujrati Practice 8",-1,0,ID2,name2);
        this.dispose();
    ...
    private void Practice9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Practice9MouseClicked
        new Practiceguj("LyukSna{pr","jeKsnS3omR","Gujrati Practice 9",-1,0,ID2,name2);
        this.dispose();
    ...
    private void Practice10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Practice10MouseClicked
        ...
        n1.setFont(new getfont().getone2(Font.PLAIN,40f));
        n2.setFont(new getfont().getone2(Font.PLAIN,40f));
        ...
        else
        {
            ...
            this.dispose();
            new Practiceguj(n1.getText(),n2.getText(),"Custom Practice",-1,0,ID2,name2);
        }
