 ...
 * @author Vrushank
 */
public class alphanumpractice extends javax.swing.JFrame {
    ...
    public alphanumpractice(String practice, int rec, int err, String ID2, String name) {
        flag = 0;
        for (int i = 0; i < 20; i++) {
            a[i] = randomAlphaNumeric(6);
        }
        id = ID2;
        name2 = name;
        pra = practice;
    ...
    private void initComponents() {
        ...
        Titlelbl.setFont(new getfont().getone(42f));
    ...
    private void controlfld2(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_controlfld2
        ...
        if (jf.getText().length() == String.valueOf(a[flag]).length() && evt.getKeyChar() != 8) {
            if (jf.getText().equals(String.valueOf(a[flag])) && getFocusOwner() != element10lbl11) {
                ...
                if (a == 0) {
                   new alphanumpractice(pra, record, error, id, name2);
                    this.dispose();
                } else {
    ...
    private void controlfld(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_controlfld
        ...
        if (jf.getText().length() == String.valueOf(a[flag]).length() && evt.getKeyChar() != 8) {
            if ((String.valueOf(a[flag])).equals(jf.getText()) && getFocusOwner() != element10lbl11) {
                ...
                int a = JOptionPane.showConfirmDialog(rootPane, "Do you want to do this practice again??", "Confirm", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource("/icons8-ask_question.png")));
                if (a == 0) {
                    new alphanumpractice("AlphaNumeric Practice", -1, 0, id,name2);
                    this.dispose();
                } else {
                    if (!name2.equals("guest")) 
                    {
