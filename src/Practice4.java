...
public class Practice4 extends javax.swing.JFrame {
    ...
    int timerflag=0;
    String s1[]={"Pack my box with five dozen liquor jugs.","How quickly draft jumping zebras vex.","Sphinx of black quartz, judge my vow.","Jackdaws love my big sphinx of quartz.","The quick brown goblin jumps over the lazy dwarf."};
    int error,record,flag;
    
    public Practice4(String practice,int rec,int err,String ID2,String name) {
        pra=practice;
        name2=name;
        record=rec+1;        
        ID=ID2;
    ...
    private void initComponents() {
        ...
        element11.setText("Pack my box with five dozen liquor jugs.");
        ...
        element13.setText("How quickly draft jumping zebras vex.");
        ...
        element15.setText("Sphinx of black quartz, judge my vow.");
        ...
        element16.setText("Jackdaws love my big sphinx of quartz.");
        ...
        element19.setText("The quick brown goblin jumps over the lazy dwarf.");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(mytitle, javax.swing.GroupLayout.PREFERRED_SIZE, 389, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void controlfld(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_controlfld
        ...
        {
            timerflag=1;
            starth=Integer.parseInt(DateTimeFormatter.ofPattern("HH").format(LocalDateTime.now()));
            startm=Integer.parseInt(DateTimeFormatter.ofPattern("mm").format(LocalDateTime.now()));
            starts=Integer.parseInt(DateTimeFormatter.ofPattern("ss").format(LocalDateTime.now()));
            starts=starts+(startm*60)+(starth*3600);
        }
        JTextField jf = (JTextField) getFocusOwner();
        if (jf.getText().length() == s1[flag].length() && evt.getKeyChar() != 8) {
            if (jf.getText().equals(s1[flag]) && getFocusOwner()!=element9lbl10) {
                jf.getNextFocusableComponent().setFocusable(true);
                jf.getNextFocusableComponent().requestFocus();
                jf.setFocusable(false);
                flag++;
            } else if(jf.getText().equals(s1[flag]) && getFocusOwner()==element9lbl10)
            {
                endh=Integer.parseInt(DateTimeFormatter.ofPattern("HH").format(LocalDateTime.now()));
                endm=Integer.parseInt(DateTimeFormatter.ofPattern("mm").format(LocalDateTime.now()));
                ends=Integer.parseInt(DateTimeFormatter.ofPattern("ss").format(LocalDateTime.now()));
                ends=ends+(endm*60)+(endh*3600);
                int a=JOptionPane.showConfirmDialog(rootPane,"you have completed around 33 words in "+((float)((ends-starts)))+" minuts. "+"Do you want to do this practice again??", "Confirm",JOptionPane.YES_NO_OPTION,JOptionPane.INFORMATION_MESSAGE,new ImageIcon(getClass().getResource("/icons8-ask_question.png")));                
                if(a==0)
                {                    
                    this.dispose();  
                    new Practice4(pra,record,error,ID,name2);
                }
                else
                {
