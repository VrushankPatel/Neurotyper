 ...
 * @author Vrushank
 */
public class numpractice extends javax.swing.JFrame {

    String maintext,pra,id,name2;
    int posX, posY,record,flag;
    int error;
    int a[]=new int[20];

    public numpractice(String practice,int rec,int err,String ID2,String name) {
        flag=0;              
        for(int i=0;i<20;i++)
        {
            a[i]=new java.util.Random().nextInt((9999999-1000000)+1)+1000000;
        }      
        id=ID2;
        name2=name;
        pra=practice;
    ...
    private void initComponents() {
        ...
        Titlelbl.setFont(new getfont().getone(48f));
        ...
        element1.setFont(new getfont().getone(Font.BOLD,24f));
        element1.setForeground(new java.awt.Color(102, 153, 255));
        element1.setText(String.valueOf(a[0]));

        element1lbl1.setBackground(new java.awt.Color(230, 230, 230));
        element1lbl1.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element2.setFont(new getfont().getone(Font.BOLD,24f));
        element2.setForeground(new java.awt.Color(102, 153, 255));
        element2.setText(String.valueOf(a[1]));

        element2lbl2.setBackground(new java.awt.Color(230, 230, 230));
        element2lbl2.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element3.setFont(new getfont().getone(Font.BOLD,24f));
        element3.setForeground(new java.awt.Color(102, 153, 255));
        element3.setText(String.valueOf(a[2]));

        element3lbl3.setBackground(new java.awt.Color(230, 230, 230));
        element3lbl3.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element4.setFont(new getfont().getone(Font.BOLD,24f));
        element4.setForeground(new java.awt.Color(102, 153, 255));
        element4.setText(String.valueOf(a[3]));

        element4lbl4.setBackground(new java.awt.Color(230, 230, 230));
        element4lbl4.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element5.setFont(new getfont().getone(Font.BOLD,24f));
        element5.setForeground(new java.awt.Color(102, 153, 255));
        element5.setText(String.valueOf(a[4]));

        element5lbl5.setBackground(new java.awt.Color(230, 230, 230));
        element5lbl5.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element6.setFont(new getfont().getone(Font.BOLD,24f));
        element6.setForeground(new java.awt.Color(102, 153, 255));
        element6.setText(String.valueOf(a[6]));

        element6lbl6.setBackground(new java.awt.Color(230, 230, 230));
        element6lbl6.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element7.setFont(new getfont().getone(Font.BOLD,24f));
        element7.setForeground(new java.awt.Color(102, 153, 255));
        element7.setText(String.valueOf(a[7]));

        element7lbl7.setBackground(new java.awt.Color(230, 230, 230));
        element7lbl7.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element8lbl8.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element8.setFont(new getfont().getone(Font.BOLD,24f));
        element8.setForeground(new java.awt.Color(102, 153, 255));
        element8.setText(String.valueOf(a[5]));

        element9.setFont(new getfont().getone(Font.BOLD,24f));
        element9.setForeground(new java.awt.Color(102, 153, 255));
        element9.setText(String.valueOf(a[8]));

        element9lbl9.setBackground(new java.awt.Color(230, 230, 230));
        element9lbl9.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element10.setFont(new getfont().getone(Font.BOLD,24f));
        element10.setForeground(new java.awt.Color(102, 153, 255));
        element10.setText(String.valueOf(a[9]));

        element10lbl10.setBackground(new java.awt.Color(230, 230, 230));
        element10lbl10.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element11.setFont(new getfont().getone(Font.BOLD,24f));
        element11.setForeground(new java.awt.Color(102, 153, 255));
        element11.setText(String.valueOf(a[10]));

        element1fld1.setBackground(new java.awt.Color(230, 230, 230));
        element1fld1.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element12.setFont(new getfont().getone(Font.BOLD,24f));
        element12.setForeground(new java.awt.Color(102, 153, 255));
        element12.setText(String.valueOf(a[11]));

        element2fld1.setBackground(new java.awt.Color(230, 230, 230));
        element2fld1.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element13.setFont(new getfont().getone(Font.BOLD,24f));
        element13.setForeground(new java.awt.Color(102, 153, 255));
        element13.setText(String.valueOf(a[12]));

        element3fld4.setBackground(new java.awt.Color(230, 230, 230));
        element3fld4.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element14.setFont(new getfont().getone(Font.BOLD,24f));
        element14.setForeground(new java.awt.Color(102, 153, 255));
        element14.setText(String.valueOf(a[13]));

        element4fld5.setBackground(new java.awt.Color(230, 230, 230));
        element4fld5.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element15.setFont(new getfont().getone(Font.BOLD,24f));
        element15.setForeground(new java.awt.Color(102, 153, 255));
        element15.setText(String.valueOf(a[14]));

        element5fld6.setBackground(new java.awt.Color(230, 230, 230));
        element5fld6.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element16.setFont(new getfont().getone(Font.BOLD,24f));
        element16.setForeground(new java.awt.Color(102, 153, 255));
        element16.setText(String.valueOf(a[16]));

        element6lbl7.setBackground(new java.awt.Color(230, 230, 230));
        element6lbl7.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element17.setFont(new getfont().getone(Font.BOLD,24f));
        element17.setForeground(new java.awt.Color(102, 153, 255));
        element17.setText(String.valueOf(a[17]));

        element7lbl8.setBackground(new java.awt.Color(230, 230, 230));
        element7lbl8.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element8lbl9.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element18.setFont(new getfont().getone(Font.BOLD,24f));
        element18.setForeground(new java.awt.Color(102, 153, 255));
        element18.setText(String.valueOf(a[15]));

        element19.setFont(new getfont().getone(Font.BOLD,24f));
        element19.setForeground(new java.awt.Color(102, 153, 255));
        element19.setText(String.valueOf(a[18]));

        element9lbl10.setBackground(new java.awt.Color(230, 230, 230));
        element9lbl10.setFont(new getfont().getone(Font.BOLD,24f));
        ...
        element20.setFont(new getfont().getone(Font.BOLD,24f));
        element20.setForeground(new java.awt.Color(102, 153, 255));
        element20.setText(String.valueOf(a[19]));

        element10lbl11.setBackground(new java.awt.Color(230, 230, 230));
        element10lbl11.setFont(new getfont().getone(Font.BOLD,24f));
    ...
    private void controlfld2(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_controlfld2
        ...
        if (jf.getText().length() == String.valueOf(a[flag]).length() && evt.getKeyChar() != 8) {
            if (jf.getText().equals(String.valueOf(a[flag])) && getFocusOwner()!=element10lbl11) {
                jf.getNextFocusableComponent().setFocusable(true);
                jf.getNextFocusableComponent().requestFocus();
                jf.setFocusable(false);
                flag++;
            }else if(jf.getText().length() == String.valueOf(a[flag]).length() && getFocusOwner()==element10lbl11)
            {
                ...
                if(a==0)
                {
                    new numpractice(pra,record,error,id,name2);
                    this.dispose();                    
                }
                else
                {
    ...
    private void controlfld(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_controlfld
        JTextField jf = (JTextField) getFocusOwner();     
        if (jf.getText().length() == String.valueOf(a[flag]).length() && evt.getKeyChar() != 8) {
            if ((String.valueOf(a[flag])).equals(jf.getText()) && getFocusOwner()!=element10lbl11) {                                
                jf.getNextFocusableComponent().setFocusable(true);
                jf.getNextFocusableComponent().requestFocus();
                jf.setFocusable(false);
                flag++;
            }else if(jf.getText().equals(String.valueOf(a[flag])) && getFocusOwner()==element10lbl11)
            {
                int a=JOptionPane.showConfirmDialog(rootPane,"Do you want to do this practice again??", "Confirm",JOptionPane.YES_NO_OPTION,JOptionPane.INFORMATION_MESSAGE,new ImageIcon(getClass().getResource("/icons8-ask_question.png")));                
                if(a==0)
                {
                    new numpractice("Numeric Practice",-1,0,id,name2);
                    this.dispose();                    
                }
                else
                {
                    new Prcticelist(id, name2);
                    this.dispose();
                }
                if(!name2.equals("Guest"))
                {
    ...
    public static void main(String args[]) {
        new numpractice("demoone",-1,0,"Guest","Guest");
    }
